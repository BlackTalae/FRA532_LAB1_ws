...
def generate_launch_description():
    ...
    rviz_config_path = os.path.join(package_dir, 'config', '3_all_config.rviz')
    slam_params_path = os.path.join(package_dir, 'config', 'slam_params.yaml')
